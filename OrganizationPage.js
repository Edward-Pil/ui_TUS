...
class OrganizationPage extends BasePage {
  constructor(driver) {    
    ...
    this.organizationURL = 'https://m71761.business.ru/organization';
    // this.organizationURL = 'https://cloud5.cloud365.su:81//organization';
  ...
  async goPage() {
    await this.driver.get(this.organizationURL);
  }
